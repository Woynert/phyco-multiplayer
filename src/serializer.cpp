...
void serialize_inputs (Ref<StreamPeerBuffer> buf)
{
	...
	// int hKey = input->is_action_pressed("gm_right") -
	// input->is_action_pressed("gm_left"); int vKey =
	// input->is_action_pressed("gm_down") - input->is_action_pressed("gm_up");
	...
	PacketInput::Write (
		buf, input->is_action_pressed ("ui_up"),
