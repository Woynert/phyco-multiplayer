...
bool add_player_to_slot (
	godot::Server* server, int slot, godot::Ref<godot::ENetPacketPeer> peer)
{
...
int get_slot_from_peer (
	godot::Server* server, godot::Ref<godot::ENetPacketPeer> peer)
{
...
bool free_slot (godot::Server* server, godot::Ref<godot::ENetPacketPeer> peer)
{
